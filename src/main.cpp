...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 5000000); // BitRupiah: 5000000 blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // BitRupiah: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // BitRupiah: 2.5 minutes
